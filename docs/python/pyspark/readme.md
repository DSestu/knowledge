...
- [Scalars \& arrays](#scalars--arrays)
  - [Arrays](#arrays)
    - [Making a "set"/array](#making-a-setarray)
    - [Sorting an array](#sorting-an-array)
    - [Getting the size of an array](#getting-the-size-of-an-array)
    - [Intersection between multiple arrays](#intersection-between-multiple-arrays)
  - [Scalars](#scalars)
- [Some equivalences with pandas syntax](#some-equivalences-with-pandas-syntax)
  - [The `col()` cursor](#the-col-cursor)
  - [Checking null values](#checking-null-values)
  - [Merging](#merging)
  - [Filtering data](#filtering-data)
  - [`select()` is equivalent to `get()` in pandas](#select-is-equivalent-to-get-in-pandas)
  - [Dropping a column](#dropping-a-column)
  - [Alias](#alias)
  - [Explode](#explode)
  - [Getting column names](#getting-column-names)
  - [Drop duplicates](#drop-duplicates)
  - [Creating a column in an assign style (withColumn)](#creating-a-column-in-an-assign-style-withcolumn)
  - [GroupBy Agg](#groupby-agg)
  - [expr](#expr)
  - [Melt](#melt)
  - [Cast as timestamp](#cast-as-timestamp)
  - [Timestamp to date](#timestamp-to-date)
  - [Date to day of the year](#date-to-day-of-the-year)
  - [Create bins](#create-bins)
  - [Gathering a pandas dataframe](#gathering-a-pandas-dataframe)
  - [`.show()` equivalent to `.head()` in pandas](#show-equivalent-to-head-in-pandas)
  - [H3](#h3)
    - [Geo to h3](#geo-to-h3)
    - [Distance between locations](#distance-between-locations)
  - [Saving data in the metastore](#saving-data-in-the-metastore)
